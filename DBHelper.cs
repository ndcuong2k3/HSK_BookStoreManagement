...
namespace HSK_BookStoreManagement
{
    ...
    {
        private readonly string connectionString = "Server=CUONG\\MSSQLSERVER01;Database=BookStoreManagement_Final;User Id=sa;Password=cuong;TrustServerCertificate=True;";
